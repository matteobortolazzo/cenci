...
| `codex-runtime` | — | — | — | — |
| `configure` | — | babysit,codex-runtime implement,shell-rules testing,verify-ui | detect-project.sh | code-reviewer |
...
│   │   └── clients.md
│   └── scripts/
│       └── check.sh            # Deterministic repo-consistency checker (19 categories, JSON+text report)
├── tests/
