...
# --base-version <ver|null>, and --dind <true|false>, and prints the full
# merged config to stdout. Enabling/disabling either sibling never touches
# the other's fields or unrelated keys; an emptied `sandbox` object is
...
CFG="$(write_config '{}')"
run_merge "${CFG}" --dockerfile true --base-version 24.04 --dind true
...
CFG="$(write_config '{}')"
run_merge "${CFG}" --dockerfile false --base-version null --dind true
...
CFG="$(write_config '{}')"
run_merge "${CFG}" --dockerfile false --base-version null --dind false
...
run_merge "${CFG}" --dockerfile true --base-version 22.04 --dind false
...
run_merge "${CFG}" --dockerfile true --base-version 22.04 --dind true
...
CFG="$(write_config '{}')"
run_merge "${CFG}" --dockerfile true --base-version null --dind false
