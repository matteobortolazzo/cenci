...
func runWidgetJSON(args []string) {
	...
	wcfg := status.Config{
		...
		SymbolEscalated:       defaults.SymbolEscalated,
	...
	fs.StringVar(&wcfg.SymbolEscalated, "symbol-escalated", wcfg.SymbolEscalated, "symbol for a planner-escalated (Input Needed) ticket")
